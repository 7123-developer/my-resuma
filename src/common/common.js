export const api = {
    ...
    education: [
      {
        ...
        description: "",
        graduated: "June 2020",
        school: "Rayat Bahra Institute Of Engineering and Nanotechnology(IKJPTU)"
      },
      // {
  ...
  testimonials: {
    testimonials: [
      ...
      {
        text: "That Tim Baker must be one of the most brilliant developers I've ever met! It is amazing that nobody has hired him yet. Hey you, you should hire this guy, he may be fresh out of Un",
